...
`ProgressBar`在有些系统中（如Windows 7和Mac OS）支持三种类型的状态：`SWT.NORMAL`，`SWT.ERROR`和`SWT.PAUSED`。一般情况下会在[TaskBar](https://github.com/ecsoya/eclipse.tutorial/wiki/TaskBar-Tutorial)上面以不同的颜色同步显示进度。
...
上一篇：[CoolBar Tutorial](https://github.com/ecsoya/eclipse.tutorial/wiki/CoolBar-Tutorial)
下一篇：[ScrollBar Tutorial](https://github.com/ecsoya/eclipse.tutorial/wiki/ScrollBar-Tutorial)
