...
先看看SWT中的标准的Layout吧：它们都包含在`org.eclipse.swt.layout.*`包中。
  ...
  * [FillLayout](https://github.com/ecsoya/eclipse.tutorial/wiki/FillLayout-Tutorial)
  * [RowLayout](https://github.com/ecsoya/eclipse.tutorial/wiki/RowLayout-Tutorial)
  * [GridLayout](https://github.com/ecsoya/eclipse.tutorial/wiki/GridLayout-Tutorial)
  * [FormLayout](https://github.com/ecsoya/eclipse.tutorial/wiki/FormLayout-Tutorial)

在SWT的custom包中也有一个Layout，`org.eclipse.swt.custom.StackLayout`

  * [StackLayout](https://github.com/ecsoya/eclipse.tutorial/wiki/StakLayout-Tutorial)
